...
function StatCard({ title, value, icon: Icon, trend, trendValue, color, subtitle }) {
  ...
  return (
    <div className="bg-black border border-white/10 rounded-2xl p-5 hover:border-white/20 transition-all duration-300 group">
...
function TrendTooltip({ active, payload, label }) {
  ...
  return (
    <div className="bg-zinc-950 border border-white/10 rounded-xl px-4 py-3 shadow-xl shadow-black/20">
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        <div className="col-span-2 bg-black border border-white/10 rounded-2xl p-5" style={{ width: '100%', height: 350 }}>
        ...
        <div className="bg-black border border-white/10 rounded-2xl p-5" style={{ width: '100%', height: 340 }}>
          <div className="mb-4">
      ...
      <div className="bg-black border border-white/10 rounded-2xl p-5">
        <div className="flex items-center justify-between mb-5">
          ...
          <button
            ...
            className="flex items-center gap-1.5 text-[11px] text-white hover:text-white/80 font-medium transition-colors"
          >
            Tümünü Gör
        ...
        {/* Tablo Başlığı */}
        <div className="grid grid-cols-12 gap-4 px-4 py-2.5 text-[11px] text-slate-500 font-semibold uppercase tracking-wider border-b border-white/10">
        ...
        {topRiskTransactions.map((txn) => {
          ...
          return (
            <div
              key={txn.id}
              className="grid grid-cols-12 gap-4 px-4 py-3.5 items-center border-b border-white/10 last:border-b-0 hover:bg-white/[0.03] transition-colors cursor-pointer group"
